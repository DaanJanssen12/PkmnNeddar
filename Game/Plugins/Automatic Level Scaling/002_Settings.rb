...
module LevelScalingSettings
  ...
  DIFICULTIES = [
    Difficulty.new(id: 1, fixed_increase: -4, random_increase: 2),  # Easy
    Difficulty.new(id: 2, fixed_increase: -3, random_increase: 2),  # Medium
    Difficulty.new(id: 3, fixed_increase: 0, random_increase: 1),  # Hard
  ]
